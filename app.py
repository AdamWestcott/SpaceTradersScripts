...
headers = {
    'Authorization': 'Basic ' + Keys.AUTHENTICATION,
}
faction_table = [] 
faction_row = []
faction_trait_table = [] 
...
faction_table_df = pd.DataFrame(faction_table, columns = ['Symbol', 'Name', 'Description','Headquarters Location'])
st.table(faction_table_df)
...
st.table(faction_trait_table_df)
